...
<main class="content">
	<section class="col-lg-9 col-md-9 col-sm-12 left-side textpage contact-page">
		...
		<div class="input-group" style="margin:10px 0 0 0;">
		  ...
		  <input type="text" class="form-control date padding10" id="date" value="<?=date("d-m-Y H:i:s")?>" />
		</div>
		...
		<div class="input-group" style="margin:10px 0 0 0;">
		  ...
		  echo $lib_modules_categorylist->catOptions($c);
		  ?>
		</div>

		<div class="input-group" style="margin:10px 0 0 0;">
		  <label for="title">დასახელება: <font color="red">*</font></label>
		  <input type="text" class="form-control title padding10" id="title" value="" />
		</div>		

		<div class="input-group" style="margin:10px 0 0 0;">
		  <label for="metatitle">მეტა დასახელება: <font color="red">*</font></label>
		  <input type="text" class="form-control metatitle padding10" id="metatitle" value="" />
		</div>

		<div class="input-group" style="margin:10px 0 0 0;">
		  <label for="metadescription">მეტა აღწერა: <font color="red">*</font></label>
		  <textarea class="form-control" id="metadescription" class="metadescription"></textarea>
		</div>

		<div class="input-group" style="margin:10px 0 0 0;">
		  <label for="shortdescription">მოკლე აღწერა: <font color="red">*</font></label>
		  <textarea class="form-control" id="shortdescription" class="shortdescription"></textarea>
		</div>

		<div class="input-group" style="margin:10px 0 0 0;">
		  <label for="text">ტექსტი: <font color="red">*</font></label>
		  <textarea class="form-control" id="text" class="text"></textarea>
		</div>

		<div class="input-group" style="margin:10px 0 0 0;">
		  <label for="tags">ტეგები: <font size="2">( გამოყავით მძიმით მაგ: სარკოიდოზი, პესტიციდები, და ა.შ.)</font> <font color="red">*</font></label>
		  <input type="text" class="form-control tags padding10" id="tags" value="" />
		</div>
		</form>

		<a href="javascript:void(0)" class="btn btn-primary" id="mystatia_button" data-type="add">შენახვა</a>
